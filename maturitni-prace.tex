...
\pagenumbering{roman}                   % číslování stránek římskými číslicemi
	...
	\abstrakt{
		V této práci se zabýváme problematikou konstrukce kvadrokoptéry ve spojení s mikrořadičem Arduino. Rozebíráme jak fungují její základní komponenty, principy fyziky letu. Praktická část práce se zaměřuje na návrh a sestavení skutečné kvadrokoptéry. 
	}{
		kvadrokoptéra, konstrukce dronu, Fyzika letu, Arduino 
	}

...
\pagenumbering{roman}                   % číslování stránek římskými číslicemi
	...
	\abstrakt{
		Tato práce se zabývá problematikou konstrukce kvadrokoptéry ve spojení s~mikrořadičem Arduino. Rozebíráme, jak fungují její základní komponenty a principy fyziky letu. Praktická část práce se zaměřuje na návrh a sestavení skutečné kvadrokoptéry. 
	}{
		Kvadrokoptéra, konstrukce dronu, fyzika letu dronu, Arduino 
	}
	
	\podekovani{
		Rád bych poděkoval svému vedoucímu práce Dr. rer. nat. Michalu Kočerovi, který mi byl oporou při psaní práce, ochotně se mnou konzultoval její průběh a jehož zásluhou jsem ji mohl vypracovat bez větších problémů. Dále bych chtěl poděkovat svému bývalému spolužákovi Šimonu Borovkovi, se kterým jsme tento projekt před několika lety společně začali a já jsem ho nyní měl možnost dokončit. Mé díky patří také mým rodičům, kteří byli jedni z~prvních, kdo mou práci četli a pomohli mi s~její jazykovou korekturou. V~neposlední řadě bych chtěl poděkovat Jonáši Havelkovi, jehož šablonu pro \LaTeX~jsem v~práci použil a Václavu Baureovi a jeho maturitní práci na téma Systém Ball and Beam, která mi v~mnoha případech posloužila jako cenný zdroj inspirace.
	}
...
Tato práce se zaměřuje na konstrukci dronů, konkrétně kvadrokoptér, a to z~teoretického i praktického hlediska. V~první části jsou popsány základní pojmy a charakteristiky dronů zahrnující jejich různé typy, specifikace a fungování klíčových komponent. Druhá část práce se zaměřuje na samotnou konstrukci kvadrokoptéry od návrhu rámu až po integraci elektroniky a softwaru.

Hlavním účelem této práce je posloužit jako návodný materiál pro kohokoliv, kdo má zájem vyrobit si vlastní kvadrokoptéru v~domácích podmínkách, a to i bez předchozích zkušeností. Práce poskytuje čtenáři základní vhled do celé problematiky a slouží jako odrazový bod pro jeho budoucí konstrukční projekty.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{vrtule.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{letici-dron.jpeg}
